...
parser.add_argument("-G", "--grid_search_trials", type=int, default=0,
                    help="Treinar modelos com diversos hyperparametros (setar > 0 para rodar) - [Modelos TransferLearning/CNN hardcoded]")
...
config = ModelConfig(model_set_enum=modelSetEnum, path_csv=pathCsv, dir_base_img=dir_base_img,
                     ...
                     args_name_model=args.name, args_trainable=args.trainable,
